...
public class ActivityLog {
    ...
    void syncCompatibilityColumns() {
        if (actionCode == null && legacyAction != null) actionCode = legacyAction;
        if (legacyAction == null && actionCode != null) legacyAction = actionCode;
        if (message == null && legacyDetails != null) message = legacyDetails;
        if (legacyDetails == null && message != null) legacyDetails = message;
    }
}
