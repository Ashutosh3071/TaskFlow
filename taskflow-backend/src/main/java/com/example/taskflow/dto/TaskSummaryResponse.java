...
public class TaskSummaryResponse {
    ...
    public TaskSummaryResponse(int totalTasks, ByStatus byStatus, ByPriority byPriority,
                               double completionRate, int overdueCount, int tasksThisWeek, int dueToday) {
