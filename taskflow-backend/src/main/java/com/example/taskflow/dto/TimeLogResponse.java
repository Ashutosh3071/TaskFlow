...
public class TimeLogResponse {
    ...
    public TimeLogResponse(Long id, Long taskId, Long loggedById, String loggedByName, int durationMinutes, LocalDate logDate, String note, boolean manual, Instant createdAt) {
        this.id = id;
        this.taskId = taskId;
